...
CREATE TABLE BOOK_DELETE (
    ...
    CONSTRAINT fk_idUser_delete_admin FOREIGN KEY (idAdmin) REFERENCES USERS(id) ON SET NULL CASCADE ON UPDATE CASCADE,
...
CREATE TABLE BOOK_LIST (
    ...
    PRIMARY KEY(id),
    CONSTRAINT fk_list FOREIGN KEY (idUserCreator) REFERENCES USERS(id) ON DELETE SET NULL CASCADE ON UPDATE CASCADE,
) ENGINE=InnoDB;
